(function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
    ...
    function CommentForm(_ref) {
      ...
      var _useState = (0, _react.useState)(''),
          ...
          setComment = _useState2[1]; // Declare isCreatePending.
    
    
      var isCreatePending = (0, _reactRedux.useSelector)(_commentsSlice.createCommentIsPending);
    
      var handleSubmit = function handleSubmit(e) {
        e.preventDefault(); // dispatch your asynchronous action.
    ...
    var Comments = function Comments() {
      var dispatch = (0, _reactRedux.useDispatch)();
      var article = (0, _reactRedux.useSelector)(_currentArticleSlice.selectCurrentArticle); // Declare additional selected data.
      ...
      var commentsForArticleId = article === undefined ? [] : comments[article.id]; // Dispatch loadCommentsForArticleId with useEffect.
    ...
    }()); // Create postCommentForArticleId.
